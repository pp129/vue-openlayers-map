...
import VCluster from '@/components/layers/cluster/index'
...
const components = [VMap, VOverview, VOverlay, VTile, VVector, VRoute, VCluster, VHeatmap, VGraphic, VDraw, VMeasure, VTrack]
