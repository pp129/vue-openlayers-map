...
function TrafficLayer(options) {
  ...
  options.colors = options.colors || ["rgba(0,192,73,0.99609375)", "rgba(242,48,48,0.99609375)", "rgba(255,159,25,0.99609375)"];
...
TrafficLayer.prototype.getTileUrl = function (x, y, z, cbkName) {
  ...
  const url =
    ...
    "&fn=" +
    cbkName +
    (this.analysis === "private" ? "&t=" + new Date().getTime() : ""); // '&udt='+ new Date().getTime()
